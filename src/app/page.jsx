...
//   const images = ["/images/image1.png", "/images/image1.png"];
...
//               className="mt-4 text-lg flex w-full md:w-auto justify-center md:justify-start border-2 border-amber-50 items-center font-extrabold bg-gradient-to-r from-blue-400 to-pink-400 text-transparent bg-clip-text py-1 px-2 rounded-lg hover:text-xl ease-in duration-300 cursor-pointer"
//             >
//               Start here...{" "}
//               <CiLocationArrow1 className="ml-2 text-amber-200 text-lg " />
//             </button>
//           </div>
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 ">
      <div className="grid text-white grid-cols-1 md:grid-cols-2 gap-6 w-full">
        <div className="py-4 md:pt-20 text-center md:text-left">
          ...
          <p className="mt-4 text-sm text-gray-200 max-w-2xl text-justify">
            I am your AI-powered debate assistant, designed to provide insightful discussions on pollution and environmental issues...
          </p>
